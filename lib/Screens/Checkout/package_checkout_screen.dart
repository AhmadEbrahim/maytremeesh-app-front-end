...
import 'package:maytremeesh/Screens/Checkout/Components/package_contents_name.dart';
import 'package:maytremeesh/Screens/Checkout/Components/pop_up.dart';
import 'package:maytremeesh/Screens/Checkout/Components/price_detail_fixed.dart';
...
class PackageCheckoutScreen extends StatelessWidget {
  const PackageCheckoutScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final items = routeArgs['items'] as List<PackageItem>;
        ...
        SingleChildScrollView(
          child: Column(
            children: [
              ...
              Header(header: 'Package Contents', size: 26),
              SizedBox(
              ...
              PriceDetails(
                  text: 'Sub Total',
                  number: (Provider.of<Counter>(context).counter * price)
              ...
              PriceDetails(
                  text: 'Total',
                  number:
                      ((Provider.of<Counter>(context).counter * (price * 1.14))
                          .toStringAsPrecision(4))),
              SizedBox(
